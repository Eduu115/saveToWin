...
export const BUILTIN_CATEGORY_RULES: CategoryRule[] = [
  ...
  { pattern: 'amazon', categoryKey: 'Other' },
  { pattern: 'zara', categoryKey: 'Clothing' },
  { pattern: 'primark', categoryKey: 'Clothing' },
  { pattern: 'hm ', categoryKey: 'Clothing' },
  { pattern: 'h&m', categoryKey: 'Clothing' },
  { pattern: 'mango', categoryKey: 'Clothing' },
  { pattern: 'pull&bear', categoryKey: 'Clothing' },
  { pattern: 'apple.com', categoryKey: 'Digital & games' },
  { pattern: 'media markt', categoryKey: 'Digital & games' },
  { pattern: 'pccomponentes', categoryKey: 'Digital & games' },
  ...
  { pattern: 'bar ', categoryKey: 'Leisure' },
  { pattern: 'pub ', categoryKey: 'Leisure' },
  { pattern: 'cine', categoryKey: 'Leisure' },
  { pattern: 'cinema', categoryKey: 'Leisure' },
  { pattern: 'bowling', categoryKey: 'Leisure' },
  { pattern: 'escape room', categoryKey: 'Leisure' },
